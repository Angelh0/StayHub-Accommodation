...
public interface AccommodationDraftService {
    ...
    AccommodationDTO stayConfiguration(UUID uuidAccommodation, AccommodationDTO accommodationDTO);
    boolean checkAddRooms (UUID uuidAccommodation);
    AccommodationDTO availabilityCalendar (UUID uuidAccommodation, AccommodationDTO accommodationDTO);
    boolean checkAvailabilityCalendar (UUID uuidAccommodation);
    AccommodationDTO addPhotos (UUID uuidAccommodation, AccommodationDTO accommodationDTO);
